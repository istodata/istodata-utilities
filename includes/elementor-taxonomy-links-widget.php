...
add_action('elementor/widgets/register', function($widgets_manager){
    ...
    $enabled = !empty($additional['elementor_taxonomy_links_widget']);
    if (!$enabled) {
        return;
    }
    ...
    require_once __DIR__ . '/elementor-taxonomy-links-widget/class-iu-taxonomy-links-widget.php';
    $widget = new \IU_Taxonomy_Links_Widget();
